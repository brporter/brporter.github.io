...
<div class="card-container">
    <div class="business-card">
        <div class="card-header">
            <img src="{{ '/assets/images/headshot.png' | relative_url }}" alt="Bryan Porter" class="headshot">
            <div class="name-title">
                <h1>Bryan Porter</h1>
                <p class="title">Principal Software Engineering Manager</p>
                <p class="employer">Microsoft</p>
            </div>
        </div>
        ...
        <div class="card-section">
            ...
            <ul class="tags">
                <li>Network Performance and Latency</li>
        ...
        <div class="card-footer">
            ...
            <a href="https://github.com/brporter" target="_blank" class="social-link">
            ...
            <a href="https://instagram.com/betaporter" target="_blank" class="social-link">
